...
public class ItemTableField : AbstractState {
	
#if UNITY_EDITOR
	public ItemTable itemTable;
	
	public ItemTableField(Vector2 position){
		this.Position= position;
		this.Size= new Vector2(140,40);
		this.Title= "Item Table";
	}
	...
	public override void DrawState ()
	{
		...
		itemTable= (ItemTable)EditorGUILayout.ObjectField("Item Table",itemTable,typeof(ItemTable),false);
		GUILayout.EndArea();
